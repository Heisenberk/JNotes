...
public class SearchTest {
	...
	public void initialize() {
		...
		try(FileWriter fw1 = new FileWriter(f1, true); 
			...
			fw1.append("=test recherche1\n");
			fw1.append("sarah pho\n");
			fw1.append("7 décembre 1995\n");
			fw2.append("=test recherche2\n");
			fw2.append("sarah pho\n");
			fw2.append("7 décembre 1995\n");
			fw3.append("=test recherche3\n");
			fw3.append("sarah pho\n");
			fw3.append("7 décembre 1995\n");
		} catch (IOException e) { 
	...
	public void testSearch1() {
		try(FileWriter fw1 = new FileWriter(f1, true); 
				FileWriter fw2 = new FileWriter(f2, true);
				FileWriter fw3 = new FileWriter(f3, true)) {
			fw1.append("* test search 1\n");
			fw2.append("* test search 2\n");
			fw3.append("* test search 1\n");
			fw3.append("* test search 2\n");
		} catch (IOException e) { 
	...
	public void testSearchTags1() {
		...
		try(FileWriter fw1 = new FileWriter(f1, true); 
			...
			fw1.append(":context: work\ntest search 1\n");
			fw2.append(":context: work\n* test search 2\n");
		} catch (IOException e) { 
